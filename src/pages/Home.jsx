...
const Planes = () => {
  const planes = [
    ...
    {
      nombre: 'MEGASIMULACROS 2000',
      precio: '50 Bs',
      color: 'border-purple-700',
      bg: 'bg-purple-50',
      popular: true,
      beneficios: [
        '2000 preguntas para el examen de Residencia Médica Bolivia 2026',
        'Todo lo que debes saber respecto a la nueva bibliografía',
        '40 simulacros completos de 50 preguntas cada uno',
        'Preguntas tipo Examen Residencia Medica Bolivia con explicaciones detalladas',
